...
pub(crate) struct Response {
    // If true, I accepted this line and you should keep sending me lines. If false, I did not accept this line, and you should handle it some other way.
...
pub(crate) trait LinesHighlighter {
    /// Consume one line of input. May or may not return a highlighted string. In case this call returns an error, this whole object will be invalid afterwards.
