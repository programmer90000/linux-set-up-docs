...
impl AnsiStyle {
    ...
    /// Renders a (possibly empty) ANSI escape sequence to switch to this style from the before style.
...
mod tests {
    ...
    fn test_from_hyperlinked() {
        ...
        // Plain to hyperlink: should emit OSC 8 with URL. Note that the URL has been normalized with a trailing slash, this is done by the URL library.
