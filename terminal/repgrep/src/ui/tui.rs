...
impl Tui {
    ...
    pub fn start(
        ...
        loop {
            ...
            // If drawing to the terminal is slow, flush all keyboard events so they're not buffered. (Otherwise with very slow updates, the user has to wait for all keyboard events to be processed before being able to quit the app, etc).
