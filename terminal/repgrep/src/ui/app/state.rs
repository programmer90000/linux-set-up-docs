...
pub struct AppListState {
    ...
    indicator: ListState,
    /// The position of the start of the visible window in the main list view. We only send the visible lines to the renderer for performance reasons, and this represents the beginning of the visible window.
    window_start: usize,
}
...
impl AppUiState {
    ...
    /// Represent the `AppUiState` as a `Text`. This is displayed as the "mode" in the stats line.
