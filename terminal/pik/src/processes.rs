...
/// This is needed as we sort by match type. Exact matches should go first, Exists should go last and fuzzy matches should be sorted by score
...
/// Refreshes the system information, including processes and their associated ports. This method spawns a separate thread to refresh the ports, as it speeds up the overall refresh process. It makes overall refreshes ~2x faster (initial refresh is slower though).
