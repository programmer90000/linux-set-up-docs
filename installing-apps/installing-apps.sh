...
cp installing-apps/config/Meltytech/Shotcut.conf ~/.config/Meltytech/
...
cp installing-apps/config/GIMP/3.0/gimprc ~/.config/GIMP/3.0/
...
cp installing-apps/config/copyq/copyq.conf ~/.config/copyq/
echo "Installing Audacity"
sudo apt install -y audacity
mkdir -p ~/.config/audacity/
cp installing-apps/config/audacity/audacity.cfg ~/.config/audacity/
echo "Installing LibreOffice"
sudo apt install -y libreoffice
mkdir -p ~/.config/libreoffice/4/user/
cp installing-apps/config/libreoffice/registrymodifications.xcu ~/.config/libreoffice/4/user/
echo "Installing Screen Ruler"
sudo apt install -y screenruler
mkdir -p ~/.config/screenruler/
cp installing-apps/config/screenruler/settings.yml ~/.config/screenruler/
...
cp installing-apps/config/hardinfo2/settings.ini ~/.config/hardinfo2/
echo "Installing Extrepo"
sudo apt install -y extrepo
sudo cp installing-apps/config.yaml /etc/extrepo/config.yaml
echo "Installing Brave Browser"
sudo extrepo enable brave_release
sudo apt update
sudo apt install -y brave-browser
mkdir -p ~/.config/BraveSoftware/Brave-Browser/Default/
cp "installing-apps/config/brave/Local State" ~/.config/BraveSoftware/Brave-Browser/
cp installing-apps/config/brave/Preferences ~/.config/BraveSoftware/Brave-Browser/Default/
cp installing-apps/config/brave/Bookmarks ~/.config/BraveSoftware/Brave-Browser/Default/