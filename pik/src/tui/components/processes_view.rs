...
//NOTE: this is wrapped in a Lazy Mutex because arboard's Clipboard may cause issues when you don't have any clipboard manager installed, and it needs to be initialized only once.
