...
pub fn main() -> iced::Result {
    ...
    iced::application("LabWC Window Switcher", WindowSwitcher::update, WindowSwitcher::view).window(iced::window::Settings { size: iced::Size::new(width, height), resizable: resizable, decorations: true, position: iced::window::Position::Centered, ..Default::default()}).run_with(|| (WindowSwitcher::new(), Task::none()))
}
